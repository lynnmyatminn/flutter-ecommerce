...
class JTCSubCategoryScreen extends StatelessWidget {
  String slug;

  JTCSubCategoryScreen({Key key, @required this.slug}) : super(key: key);
                ...
                child: TabBarView(
                  children: [
                    Container(
                      ...
                      child: JTCCategoryPage(
                          slug: 'Category/GetSubCategoryByCategory/' + slug,
                          isSubList: true),
                    ),
                    Container(
                      color: Colors.white24,
